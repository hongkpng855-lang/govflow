...
CATEGORIES = [
    ...
    ("公司文件", ["授權書", "公司印章", "Company Chop", "電子簽署", "章程", "會議紀錄", "Invoice", "收據", "公證", "文件", "ND2A", "NDR1", "周年申報", "商業登記", "撤銷註冊", "清盤", "更改公司名稱", "改名", "註冊地址變更", "公司秘書", "董事公司秘書變更", "審計報告", "商標", "盡職審查", "業務估值", "公司轉讓", "賣公司", "集團架構", "租約", "合約", "糾紛", "網站及網上營銷", "電子簽署", "會計", "銀行", "資本", "法定", "股份賣出單"]),
]
